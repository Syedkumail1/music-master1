...
var Search = /*#__PURE__*/function (_Component) {
  ...
  function Search() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function () {
      _this.props.searchArtist(_this.state.artistQuery); //this searchArtist function is coming from the App.js through props
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function (artistQuery) {
      ...
      fetch("".concat(API_ADDRESS, "/artist/").concat(artistQuery)).then(function (response) {
        ...
        // The artists being used in the following if condition is the object of json (can be seen in console.log) 
